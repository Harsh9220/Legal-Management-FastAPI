...
@staff.get("/staffs/{staff_id}", status_code=status.HTTP_200_OK)
...
@staff.put("/staff/{staff_id}", status_code=status.HTTP_200_OK)
...
@staff.put("/staff/{staff_id}/block-unblock", status_code=status.HTTP_200_OK)
...
@staff.put("/staff/{staff_id}/soft-delete", status_code=status.HTTP_200_OK)
...
@staff.put("/staff/{staff_id}/restore", status_code=status.HTTP_200_OK)
