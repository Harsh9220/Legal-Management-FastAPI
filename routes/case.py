...
async def update_case(
    case_id: int, update_data: UpdateCaseRequest, current_user: user_dependency
):
    return CaseController.update_case(case_id, update_data, current_user)


@case.delete("/case/{case_id}", status_code=status.HTTP_200_OK)
